...
## mTLS (Console -> Audit Sink)
Enable by setting:
- AUDIT_SINK_MTLS_ENABLED=true
- AUDIT_SINK_MTLS_CA_CERT=/certs/ca.crt
- AUDIT_SINK_MTLS_CLIENT_CERT=/certs/tls.crt
- AUDIT_SINK_MTLS_CLIENT_KEY=/certs/tls.key

These files should be mounted from a Kubernetes Secret.
